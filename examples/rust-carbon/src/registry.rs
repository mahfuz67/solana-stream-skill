...
pub fn instruction_specs(program: &str) -> Vec<InstructionSpec> {
    match program {
        "675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8" => vec![InstructionSpec {
            ...
            type_: "pool_created",
            id: Id::Tag(1),
            accounts: Accounts { pool: Some(4), lp_mint: Some(7), mint_a: Some(8), mint_b: Some(9), vault_a: Some(10), vault_b: Some(11) },
            mint_b_default: None,
            amount_a_offset: Some(10),
            amount_b_offset: Some(18),
            migration: None,
        }],
        "whirLbMiicVdio4qvUfM5KAg6Ct8VwpYzGff3uctyCc" => vec![InstructionSpec {
            ...
            accounts: Accounts { mint_a: Some(1), mint_b: Some(2), pool: Some(4), vault_a: Some(5), vault_b: Some(6), ..NONE },
            mint_b_default: None,
        ...
        "CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C" => vec![InstructionSpec {
            ...
            accounts: Accounts { pool: Some(3), mint_a: Some(4), mint_b: Some(5), lp_mint: Some(6), vault_a: Some(10), vault_b: Some(11) },
            mint_b_default: None,
        ...
        "6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P" => vec![InstructionSpec {
            ...
            accounts: Accounts { mint_a: Some(2), pool: Some(9), ..NONE },

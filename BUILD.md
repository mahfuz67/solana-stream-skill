# BUILD.md — building solana-stream-skill

Operational guidance for **building/maintaining this repo** (contributors, not end users). The
shipped end-user persona is [CLAUDE.md](CLAUDE.md); the runtime router is
[skill/SKILL.md](skill/SKILL.md). This file is **not** copied by the installers.
